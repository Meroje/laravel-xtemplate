...
{
    /**
     * This selector lets you select tags which have a certain value in an attribute's value
     * value. e.g.
     * 
     * div[name*='foo'] would select <div name="barfoobar"></div>
     * 
     * @author      Tobias Pohlen
     * @version     0.3
     * @package     xtemplate.selectors
     */
    class AttributeSubstr extends AttributeSelectorBase
    {
        /**
         * Selects the element
         * 
        ...
        {
            $objModel->pushAttribute("contains(@". $strName .", '". $strValue ."')");
        }
    }
}
?>